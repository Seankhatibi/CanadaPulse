...
export const sourceDatasets: SourceDatasetSeed[] = [
  ...
  },
  {
    ...
    label: "CMHC housing starts and completions",
    publisher: "CMHC",
    officialUrl: "https://www.cmhc-schl.gc.ca/professionals/housing-markets-data-and-research/housing-data",
    apiType: "CMHC_TABLE",
    cadence: "MONTHLY",
    licenseNote: "Official CMHC housing construction data.",
    updateStatus: "SOURCE_LINKED",
    latestKnownPeriod: "Detailed starts/completions importer pending",
  },
  {
