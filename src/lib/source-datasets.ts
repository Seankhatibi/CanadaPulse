...
export const sourceDatasets: SourceDatasetSeed[] = [
  ...
  },
  {
    ...
    publisher: "Statistics Canada",
    officialUrl: "https://www150.statcan.gc.ca/t1/tbl1/en/tv.action?pid=1810000401",
    apiType: "STATCAN_WDS",
    cadence: "MONTHLY",
    licenseNote: "Official Statistics Canada WDS table data.",
    updateStatus: "LIVE",
    latestKnownPeriod: "Latest monthly CPI: national, 10 provinces, household components and 12-month momentum",
  },
  {
  ...
  },
  {
    ...
    apiType: "CMHC_TABLE",
    cadence: "ANNUAL",
    licenseNote: "Official CMHC Rental Market Survey workbook.",
    updateStatus: "LIVE",
    latestKnownPeriod: "2025 rent, vacancy and turnover by province and major centre",
  },
  {
