      ...
      <div className="grid gap-5 lg:grid-cols-[1fr_0.9fr]">
        <GlassPanel className="p-5 sm:p-7">
          <div className="flex flex-wrap gap-2">
            <StatusPill>Source map</StatusPill>
            <StatusPill>Canada Pulse data</StatusPill>
            <StatusPill>{liveSummary.live} live feeds</StatusPill>
            <StatusPill>{liveSummary.pending} monitored</StatusPill>
          </div>
          <div className="mt-8">
            <SectionHeader
              eyebrow="Sources"
              title="The public-data map behind Canada Pulse."
              body="This page shows the source families Canada Pulse watches for official economic, housing, population, health, trade, energy and public-money signals."
            />
          </div>
      ...
      <section className="mt-5 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
        <GlassPanel className="p-5 lg:col-span-2">
          ...
          <p className="mt-2 text-sm leading-6 text-stone-600 dark:text-stone-400">
            Canada Pulse watches official sources first and labels market data separately when it is used.
          </p>
            ...
            {liveDataConnections.map((source) => (
              ...
              >
                ...
                <p className="mt-3 text-sm leading-6 text-stone-600 dark:text-stone-400">
                  Source family used for Canada Pulse charts, rankings and plain-English breakdowns.
                </p>
